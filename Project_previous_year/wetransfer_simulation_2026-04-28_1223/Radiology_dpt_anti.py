...
from Distributions_antitethic import Normal_distribution, Exponential_distribution
...
class RadiologyDept:
    ...
    def output(self):
        file1 = open("Output_anti_New_2_4.txt", "w")
        for i1 in range(0, self.nr_stations):
        ...
        for i1 in range(0, self.N):  # PRINT system time = cycle time (observations and running average)
